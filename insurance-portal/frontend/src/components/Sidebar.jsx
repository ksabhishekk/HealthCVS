    ...
    <aside className="w-64 min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      <div className="px-6 py-5 border-b border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-sm leading-tight">Star Health Insurance</div>
            <div className="text-xs text-slate-400">HealthCVS Portal</div>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-slate-700">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-8 h-8 rounded-lg bg-emerald-600 flex items-center justify-center text-xs font-bold shrink-0">
